...
namespace ResponsibilityChain
{
    ...
    public abstract class Handler<TIn, TOut> : IHandler<TIn, TOut>
    {
        ...
        /// <summary>
        /// <para>Invokes child handlers one by one until the <paramref name="input"/> has been processed by a child handler and returns output, ignoring the
        /// rest of the handlers.</para>
