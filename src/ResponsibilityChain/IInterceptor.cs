...
namespace ResponsibilityChain
{
    ...
    {
        /// <summary>
        /// <para>The interceptor is in control, either do something before/after the <paramref name="handler"/>'s
        /// execution, or just bypass the <paramref name="handler"/> and move on to the <paramref name="next"/>.</para>
        /// 
        /// <para>This could be used to implement cross-cutting concerns, such as auditing, logging, transaction,
        /// opting-out a feature, etc.</para>
        /// </summary>
