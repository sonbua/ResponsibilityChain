...
namespace ResponsibilityChain
{
    ...
    /// <para>In most cases, the generic version <see cref="IHandler{TIn,TOut}"/> or <see cref="IAsyncHandler{TIn,TOut}"/> should be the one to be implemented, and not this one.</para>
    /// </summary>
